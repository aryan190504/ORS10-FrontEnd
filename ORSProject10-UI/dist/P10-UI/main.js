...
var FileComponent = /** @class */ (function () {
    ...
    FileComponent.prototype.onSubmit = function (fileToUpload) {
        ...
        return this.httpClient.post("http://localhost:4200/User/profilePic/1", formData);
    };
...
var ForgotPasswordComponent = /** @class */ (function () {
    function ForgotPasswordComponent(httpService, dataValidator, router) {
        ...
        this.router = router;
        this.endpoint = "http://localhost:4200/Auth";
        this.form = {
            error: false,
            message: "",
            loginId: '',
...
var SignUpComponent = /** @class */ (function () {
    function SignUpComponent(serviceLocator, httpService, dataValidator, router) {
        ...
        this.dataValidator = dataValidator;
        this.router = router;
        this.endpoint = "http://localhost:4200/Auth/signUp";
        this.form = {
            error: false,
            message: '',
            data: { id: null },
...
var GetmarksheetComponent = /** @class */ (function (_super) {
    ...
    GetmarksheetComponent.prototype.go = function () {
        ...
        this.httpservice.get("http://localhost:4200/Marksheet/rollno/" + this.form.data.rollNo, function (res) {
            if (res.success) {
                _self.form.list = res.result.data;
                if (_self.form.list.length == 0) {
                    _self.form.message = "No record found";
...
var MarksheetListComponent = /** @class */ (function (_super) {
    ...
    MarksheetListComponent.prototype.getImage = function (id) {
        ...
        this.httpClient.get('http://localhost:4200/Marksheet/profilePic/' + this.form.data.id, { responseType: 'blob' }).subscribe(function (data) {
...
var MarksheetComponent = /** @class */ (function (_super) {
    ...
    MarksheetComponent.prototype.onSubmitProfile = function (fileToUpload, marksheetform) {
        ...
        return this.httpClient.post("http://localhost:4200/User/profilePic/" + this.form.data.id, formData);
    };
...
var MarksheetmeritListComponent = /** @class */ (function (_super) {
    ...
    MarksheetmeritListComponent.prototype.getMeritList = function () {
        var _self = this;
        this.httpservice.get("http://localhost:4200/Marksheet/meritlist", function (res) {
            if (res.success) {
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.ngOnInit = function () {
        // var _self = this;
        // this.httpService.get("http://localhost:4200/Auth/menu",function (res){
        //   if(res.success){
        //     _self.form.list = res.result.list;
        //   }else{
        //     _self.form.error = false;
...
var ChangepasswordComponent = /** @class */ (function (_super) {
    ...
    ChangepasswordComponent.prototype.changePassword = function () {
        var _self = this;
        this.form.data.loginId = localStorage.getItem("loginId");
        this.httpService.post("http://localhost:4200/User/changepassword", this.form.data, function (res) {
            if (res.success) {
                _self.form.list = res.result.data;
                _self.form.message = res.result.message;
            }
...
var UserListComponent = /** @class */ (function (_super) {
    ...
    UserListComponent.prototype.getImage = function (id) {
        ...
        this.form.data.id = id;
        console.log(this.form.data.id);
        this.httpClient.get('http://localhost:4200/User/profilePic/' + this.form.data.id, { responseType: 'blob' }).subscribe(function (data) {
            _this.createImageFromBlob(data);
            _this.myKey = _this.form.data.id;
        }, function (error) {
            console.log(error);
...
module.exports = __webpack_require__(/*! D:\WorkSpace\Project10\Project_10\ORSProj10\ORSProject10-UI\src\main.ts */"./src/main.ts");
